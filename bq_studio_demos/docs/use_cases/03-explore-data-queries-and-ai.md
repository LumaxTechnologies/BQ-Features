...
Save each as a **saved query** (Save button, name, region). They will appear under **Explorer → Queries**. Use **Share** to grant teammates **Code Viewer** or **Code Editor**. See [repositories.md](../features/1-studio/repositories.md) (saved queries, sharing).
